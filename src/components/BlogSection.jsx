...
export const BlogSection = () => {
  ...
  return (
    <section id="blog" className="py-20 bg-gray-50 dark:bg-neutral-950">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <motion.div
              ...
              className="p-6 rounded-2xl shadow-lg bg-white dark:bg-neutral-900"
            >
      ...
      <AnimatePresence>
        {selectedPost && (
          ...
          >
            <motion.div
              className="bg-white dark:bg-neutral-900 rounded-2xl max-w-2xl w-full p-8 shadow-lg overflow-y-auto max-h-[90vh]"
